...
import (
	...
	"github.com/dymensionxyz/go-ethereum/crypto/signify"
	"github.com/dymensionxyz/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/dymensionxyz/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/dymensionxyz/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/dymensionxyz/go-ethereum/core/rawdb", "github.com/dymensionxyz/go-ethereum/ethdb/leveldb"},
		{"github.com/dymensionxyz/go-ethereum/core/rawdb", "github.com/dymensionxyz/go-ethereum/ethdb/pebbledb"},
	}
